...
ALLOCATION = PyQL(
    [
        ...
        Allocation(FRAGMENTS[3], SITES[0]),
        Allocation(FRAGMENTS[4], SITES[1]),
        Allocation(FRAGMENTS[5], SITES[2]),
        Allocation(FRAGMENTS[6], SITES[3]),
        Allocation(FRAGMENTS[7], SITES[0]),
        Allocation(FRAGMENTS[8], SITES[1]),
        Allocation(FRAGMENTS[9], SITES[2]),
        Allocation(FRAGMENTS[10], SITES[3]),
